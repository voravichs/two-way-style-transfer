...
Original file is located at
    https://colab.research.google.com/drive/1gDdbrQZb2QCVFAeS9quyL0fYja3Qb1dg
"""

# Adapted from code @: https://github.com/nazianafis/Neural-Style-Transfer
...
def save_and_maybe_display(optimizing_img, dump_path, config, img_id, num_of_iterations):
    ...
    if img_id % saving_freq == 0 or img_id == num_of_iterations - 1:
...
def neural_style_transfer(config):
    ...
    out_dir_name = 'combined_' + os.path.split(content_img_path)[1].split('.')[0] + '_' + os.path.split(style_img_path)[1].split('.')[0] + config['img_suffix']
